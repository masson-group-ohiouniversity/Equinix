...
- **Spectral rank analysis** — Evolving Factor Analysis (forward + backward), Malinowski IND scree, and Target Factor Analysis on the absorbance matrix as an independent cross-check on the model rank
